...
class mlabelTestDataLoader(Dataset):
...
class img_DataLoader(Dataset):
    def __init__(self, img_path,imgSize, is_transform=None):
    ...
    def __getitem__(self, index):
        ...
        resizedImage = resizedImage.astype('float32')
        resizedImage /= 255.0
        return resizedImage, self.img_path
...
class wR2_LocDataLoader(Dataset):
    def __init__(self, img_dir, is_transform=None):
        self.img_dir = img_dir
        self.img_paths = []
        for i in range(len(img_dir)):
...
class mlabelFpsDataLoader(Dataset):
    def __init__(self, img_dir, is_transform=None):
        self.img_dir = img_dir
        self.img_paths = []
        for i in range(len(img_dir)):
